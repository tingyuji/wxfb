...
$input->SetBody("赚米吧充值");
$input->SetAttach("赚米吧充值");
$input->SetOut_trade_no(WxPayConfig::MCHID.date("YmdHis"));
$input->SetTotal_fee($fee);
$input->SetTime_start(date("YmdHis"));
$input->SetTime_expire(date("YmdHis", time() + 600));
$input->SetGoods_tag("赚米吧充值");
//$input->SetNotify_url("http://paysdk.weixin.qq.com/example/notify.php");

//$input->SetNotify_url("http://fangdan8.com/wxwx/notify.php");

$input->SetNotify_url("http://fangdan8.com/wxwx/native_notify.php");
...
//$wxClass= new wxClass();
//$wxClass->add(json_encode($result));
...
<body>
	...
	<br/><br/><br/>
	-->
	<div style="margin-left: 10px;color:#556B2F;font-size:30px;font-weight: bolder;">请用微信扫一扫</div><br/>
