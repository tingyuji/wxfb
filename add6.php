  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="page-header" style="text-align:center;">
          <p class="panel-title"><a target="_blank" href="query.php">查看是否放过</a></p>
      </div> 
      
      <div>
 
      <form class="form-horizontal" action="addtask6.php" method="post">
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <input type="text" name="price" id="price" value="0.11" disabled="disabled">
          </div>
        </div>   
